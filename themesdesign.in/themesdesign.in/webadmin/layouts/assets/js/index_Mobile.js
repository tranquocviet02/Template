document.addEventListener("DOMContentLoaded", function () {
    ...
    const Helper = (function () {
        ...
        function videoAndPop() {
            ...
            // });
            $(".play-video").on("click", function (e) {
                e.preventDefault(); // Prevent the default behavior of the clicked element (e.g., navigating to a new page)
            
                // Get the path to the video file (replace 'video.mp4' with the actual file path)
                var videoPath = "path/to/your/video.mp4";
            
                // Initialize the H5 player with appropriate options
                $(this).initH5player({
                    path: videoPath, // Specify the path to the video file
                    target: "fancybox", // Specify the target container or element (e.g., "fancybox")
