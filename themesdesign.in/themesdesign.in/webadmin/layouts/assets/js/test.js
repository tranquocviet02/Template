...
imagePreview_init = function() {
    ...
    $("#colorOptions > div").click(function() {
        ...
        n.$GoTo(s);
        n.$Pause();
        var u = $(this).attr("data-bestPrice")
          , c = $(this).attr("data-lastPrice")
          , l = $(this).attr("data-pricenote")
          , v = $(this).attr("data-hotsale")
          , i = "<strong>" + u + "<\/strong>";
        ...
        r = $(".renewPrice").attr("data-val");
        r && (h = parseInt(u.replace(/[^0-9]/g, "")) - r,
        $(".renewValue").html(h.toLocaleString("en-US") + " ₫"));
        var y = $(".eventPrice").attr("data-extra")
          , a = $(".eventPrice").attr("data-val")
          , f = $(".eventPrice").attr("data-rate");
        if (a || f) {
            var p = parseInt(y.replace(/[^0-9]/g, ""))
              , e = parseInt(u.replace(/[^0-9]/g, ""))
              , o = f > 0 ? e - e * f / 100 : e - a;
            o = o - p;
